...
public class DSterrain : MonoBehaviour
{
    ...
    public int seed; // si es 0 se genera automáticamente, si no se usa la ingresada
    ...
    void Start()
    {
        // si no se ingresó una seed, se genera una aleatoria
        if (seed == 0)
        {
        ...
        // inicializar semilla para que el resultado sea siempre el mismo con la misma seed
